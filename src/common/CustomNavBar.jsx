...
export default class CustomNavBar extends Component {
  ...
  render() {
    ...
    return (
      <div class="row navbar" ref={this.box}>
        <div class="col-sm-5 logo">
          <div class="row" style={{ alignItems: "center" }}>
            <Image
              src="assets/images/Mobile-Phone-icon.png"
              circle
            ...
            <Image
              src="assets/images/free-mail-icon.png"
              circle
              className="contact-icons"
            />
        ...
        <div class="col-sm-7 ">
          ...
          >
            <div
              class="dropdown"
              onMouseEnter={(e) => this.handleHover(e, "healthInsurance")}
            >
              <a class="nav-link" href="#/users" id="life">
                Health Insurance
              </a>
            ...
            <div
              class="dropdown"
              onMouseEnter={(e) => this.handleHover(e, "aboutUs")}
            ...
            <div
              class="dropdown"
              onMouseEnter={(e) => this.handleHover(e, "lifeInsurance")}
              onMouseLeave={(e) => this.handleHover(e, false)}
            >
              <a class="nav-link" href="/users" id="life">
                Life Insurance
